...
const Hero = () => {
  return (
    <section className="max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row w-full h-screen bg-gradient-to-r from-green-500 to-green-800">
      <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
        <h1 className="bold-32 lg:bold-64 text-center sm:text-justify">
        ...
        <Image
          src={bgHero}
          alt="Dra. Camila"
          className="absolute right-[5px] bottom-1 sm:bottom-[30px] w-36 h-56 sm:w-56 sm:h-80"
        />
      </div>
    </section>
  );
